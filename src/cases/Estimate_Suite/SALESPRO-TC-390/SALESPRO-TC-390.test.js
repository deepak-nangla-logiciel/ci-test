...
// need to handle IOS permission here while uploading image
it.skip("Verify that user can Select UpCharges and add Additional Details for Concrete Coatings Category Items", async () => {
  await estimatesPage.concreteCoatingsCategoryDetailsVerification(
    estimateTestData.quantity,
    estimateTestData.concreteCoatingTextureNo,
    estimateTestData.concreteCoatingTextureYes,
    estimateTestData.concreteCoatingColor
  );
});
});