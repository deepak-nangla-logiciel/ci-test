...
// Currently, the test case is failing due to the issue in the application and need to discuss. The test case is skipped for now.
it.skip("Price Guide Formulas", async () => {
  await estimatesPage.roofingEstimatePriceGuideFormulas(
    estimateTestData.shinglesValue
  );
});
});