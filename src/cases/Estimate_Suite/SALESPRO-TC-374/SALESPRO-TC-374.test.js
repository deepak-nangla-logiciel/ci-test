...
it("Estimates - Verify that user can result Estimate as No Sale", async () => {
  await estimatesPage.addResultAsNoSaleWithEstimate(
    estimateTestData.quantity,
    faker.number.int(10000),
    estimateTestData.salesRepUserType,
